namespace
{
	char const * vulkan_error_cstring(VkResult result)
	{
		switch(result)
		{
	...
	char const * vulkan_vk_format_string(VkFormat format)
	{
		switch (format)
		{
	...
	char const * vulkan_vk_color_space_string(VkColorSpaceKHR color_space)
	{
		switch(color_space)
		{
